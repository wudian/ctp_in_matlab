...
////////////////////////////////////////////////////////////////////////////////
int sqlite3_encode_binary(const unsigned char *ins, int n, unsigned char *out);
int sqlite3_decode_binary(const unsigned char *ins, unsigned char *out);
...
bool CppSQLite3Query::fieldisStrNULL(int nField)
{
	return (fieldDataType(nField) == SQLITE_NULL);
}


bool CppSQLite3Query::fieldisStrNULL(const char *szField)
{
	int nField = fieldIndex(szField);
	return (fieldDataType(nField) == SQLITE_NULL);
}
...
bool CppSQLite3Table::fieldisStrNULL(int nField)
{
	checkResults();
...
bool CppSQLite3Table::fieldisStrNULL(const char *szField)
{
	checkResults();
