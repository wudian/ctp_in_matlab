...
struct CThostFtdcProductField
{
	...
	///持仓类型
	TThostFtdwdPositionTypeType	PositionType;
	///持仓日期类型
	TThostFtdwdPositionDateTypeType	PositionDateType;
	///平仓处理类型
...
struct CThostFtdcInvestorPositionField
{
	...
	///持仓日期
	TThostFtdwdPositionDateType	PositionDate;
	///上日持仓
...
///当前时间
struct CThostFtdcLastTimeField
{
	///当前日期
...
struct CThostFtdcOrderField
{
	...
	///报单类型
	TThostFtdcwdOrderTypeType	OrderType;
	///今成交数量
...
///保证金监管系统经纪公司资金账户密钥
struct CThostFtdcCFMMwdTradingAccountKeyField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///经纪公司统一编码
...
struct CThostFtdcQryCFMMwdTradingAccountKeyField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
