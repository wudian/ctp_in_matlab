...
///@file ThostFtdCCTPTdApi.h
///@brief 定义了客户端接口
///@history 
///20060106	赵鸿昊		创建该文件
/////////////////////////////////////////////////////////////////////////

#if !defined(THOST_FTDCCTPTdApi_H)
#define THOST_FTDCCTPTdApi_H
...
public:
	...
	virtual void OnRspQryCFMMwdTradingAccountKey(CThostFtdcCFMMwdTradingAccountKeyField *pCFMMwdTradingAccountKey, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
...
public:
	...
	virtual int ReqQryCFMMwdTradingAccountKey(CThostFtdcQryCFMMwdTradingAccountKeyField *pQryCFMMwdTradingAccountKey, int nRequestID) = 0;
