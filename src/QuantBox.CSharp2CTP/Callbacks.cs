...
{
    public delegate void fnOnConnect(ref CThostFtdcRspUserLoginField pRspUserLogin, ConnectionStatus result);
    ...
    public delegate void fnOnRtnDepthMarketData(ref Tick pDepthMarketData);
    public delegate void fnOnTick(ref Tick pTick);
    public delegate void fnOnKLine(ref K_Line pKLine);
