...
namespace QuantBox.CSharp2CTP.Event
{
    ...
    public class OnConnectArgs : EventArgs
    {
        ...
        public OnConnectArgs(ref CThostFtdcRspUserLoginField pRspUserLogin, ConnectionStatus result)
        {
    ...
    {
        public readonly Tick pTick;
        public OnTickArgs(ref Tick pTick)
        {
            this.pTick = pTick;
        }
    }
    ...
    {
        public readonly K_Line pKLine;
        public OnKLineArgs(ref K_Line pKLine)
        {
            this.pKLine = pKLine;
        }
    }
