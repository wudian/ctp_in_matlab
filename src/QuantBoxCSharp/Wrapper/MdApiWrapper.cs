...
namespace QuantBoxCSharp
{
    public class MdApiWrapper : IDisposable
    {
        ...
        private void OnHistoryTick_callback(object sender, ref CTick pTick)
        {
            try
            {
        ...
        private void OnHistoryKLine_callback(object sender, ref CKLine pKLine)
        {   
            try
            {
        ...
        private void OnRtnDepthMarketData_KLine_callback(object sender, ref CKLine pKLine)
        {
            try
            {
