...
{
    public delegate void fnOnConnect(object sender, ConnectionStatus result);
    ...
    public delegate void fnOnTick(object sender, ref CTick pTick);
    public delegate void fnOnKLine(object sender, ref CKLine pKLine);

    public delegate void fnOnRtnDepthMarketData(object sender, ref CTick pDepthMarketData);
